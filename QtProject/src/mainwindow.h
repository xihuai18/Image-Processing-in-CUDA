...
// 具体参数意义及实现详见.cu文件
extern "C" int *getCutMask(int *src_img, int *mask_img, int img_height, int img_width);
extern "C" int *getCutMask_iSAP(int *src_img, int *mask_img, int img_height, int img_width);
extern "C" int *imgSharpen(int *src_img, int img_height, int img_width);
extern "C" int *imgBlur(int *src_img, int img_height, int img_width);
extern "C" int *imgCLAHE(int *src_img, int img_height, int img_width);
extern "C" int *imgCLAHE_Global(int *src_img, int img_height, int img_width);
