...
unsigned long long int* buildGraph(
                                   int *src_img, 
                                   int *mask_img, 
                                   int img_height, 
                                   int img_width) {
  int img_size = img_height * img_width;
  int img_num_bytes = sizeof(unsigned long long int) * img_size;
...
int *getCutMask(int *src_img, int *mask_img, int img_height, int img_width) {
  unsigned long long int *d_edges = buildGraph(
                                      src_img, mask_img, img_height, img_width);
